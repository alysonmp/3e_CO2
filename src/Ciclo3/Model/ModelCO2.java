...
@Entity
@Table(name = "CO2")
public class ModelCO2 implements Serializable{
    ...
    public ModelCO2(double pressao, double temperatura, double kv, double Cpv, double Prv, double Muv, double Vcv, double Dfv) {
    ...
    public ModelCO2(double pressao, double temperatura) {
        this.pressao = pressao;
        this.temperatura = temperatura;
    }
